...
import com.viciy.installtaskdownload.holder.DefaultDownloadViewHolder;
...
public final class DownloadManager {
    ...
    private final HashMap<String,DownloadInfo> downloadInfoMap= new HashMap<String,DownloadInfo>();
    ...
    public DownloadInfo getDownloadInfo(String name,String savePath) {
        ...
        try {
            DownloadInfo downloadInfo = db.selector(DownloadInfo.class)
                    ...
                    .findFirst();
            downloadInfoMap.put(name,downloadInfo);
        ...
        return downloadInfoMap.get(name);
    }
    ...
    public synchronized void startDownload(String url, String label, String savePath,
        ...
        downloadInfoMap.put(label,downloadInfo);
